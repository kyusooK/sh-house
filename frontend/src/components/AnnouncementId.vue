<template>
    <div>
        ...
        <div v-else>
            <BasePicker v-if="editMode" searchApiPath="announcements/search/findByGetAnnouncement" searchParameterName="title"  idField="id" nameField="title" path="announcements" label="AnnouncementId" v-model="value" @selected="pick" :editMode="editMode" />
            <div v-else style="height:100%">
                <span>{{ value && value.title ? value.title : '' }}</span>
            </div>
        </div>
    </div>
