<template>
    <div>
        ...
        <div v-else>
            <BasePicker v-if="editMode" searchApiPath="contracts" searchParameterName="title"  idField="id" nameField="title" path="contracts" label="ContractId" v-model="value" @selected="pick" :editMode="editMode" />
